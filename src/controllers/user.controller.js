...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // if (existedUser) {
  //   throw new ApiError(409, "User with email or username exists please chack");
  // }
...
const loginUser2 = asyncHandler(async (req, res) => {
  ...
  if (!username && !email) {
    throw new ApiError(400, "username or email is required1");
  }
...
const refreshAccessToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    if (incomingRefreshToken !== user?.refreshToken) {
      throw ApiError(401, "Refreshtoken is expired or used");
    }
